...
5. **The method was tested on synthetic plumes before being trusted.** EMG recovers a known emission within **+12%** (a measured bias); flux divergence within **−4%**.
...
7. **The corridor emits ~21% of the metro's NOx** (0.119 kg/s). This share is stable (20.6–21.6%) across every sensitivity test, even though absolute flux-divergence totals move by up to ±25%.
...
| NO₂ | TROPOMI OFFL L3 via Google Earth Engine, cloud fraction ≤ 0.3, solar zenith ≤ 70° |
...
Settings: 850 hPa wind, overpasses with 2–8 m/s wind, Differential Evolution (population 300, F ∈ [0.5, 1.0], CR = 0.7), 200-member bootstrap over overpasses, NOx/NO₂ = 1.32.

| Run | n | E(NOx) kg/s [95% CI] | ≈ kt/yr* | τ (h) [95% CI] | x₀ (km) | w (m/s) | R² |
|---|---|---|---|---|---|---|---|
| **Main: all windy days** | **781** | **0.524 [0.491–0.557]** | **16.5** | **1.68 [1.55–1.82]** | 25.1 | 4.14 | 0.991 |
| Easterly regime (from 45–180°) | 429 | 0.559 [0.521–0.602] | 17.6 | 1.43 [1.32–1.56] | 21.7 | 4.22 | 0.990 |
| Westerly regime (from 225–360°) | 276 | 0.451 [0.394–0.502] | 14.2 | 2.16 [1.84–2.49] | 33.5 | 4.31 | 0.981 |
| Wind 2–4 m/s | 416 | 0.480 [0.437–0.514] | 15.2 | 1.99 [1.82–2.14] | 21.5 | 3.01 | 0.994 |
| Wind 4–8 m/s | 365 | 0.506 [0.463–0.548] | 16.0 | 1.64 [1.47–1.84] | 32.0 | 5.44 | 0.985 |
| Wind at 100 m | 782 | 0.457 | 14.4 | 1.83 | 25.8 | 3.92 | 0.981 |
| Wind at 10 m | 675 | 0.349 | 11.0 | 2.35 | 28.0 | 3.31 | 0.977 |
...
- The two regimes differ by ~20%. The westerly regime has fewer overpasses and a longer lifetime.
...
Settings: 968 overpasses (wind ≤ 8 m/s), 850 hPa wind, lifetime 1.68 h from EMG, background = 10th percentile of the mean column (2.96 × 10⁻⁵ mol/m²), 200-member bootstrap.

**Two distinct hotspots, 16.7 km apart:**

| Hotspot | Location | Within 4 km | Within 6 km | Within 8 km |
|---|---|---|---|---|
| Central Pune | 18.485 N, 73.855 E (outside the corridor) | 0.046 | 0.091 | 0.147 kg/s |
| **Pimpri–Chinchwad** | **18.625 N, 73.795 E (inside the corridor)** | 0.034 | 0.069 | 0.111 kg/s |
...
|---|---|---|---|
| Pune core (≤ 10 km from source, outside the corridor) | 222 | 0.168 [0.163–0.177] | 5.3 |
| C1 Shivajinagar–Kasarwadi | 77 | 0.057 [0.056–0.060] | 1.8 |
| C2 PCMC | 55 | 0.037 [0.035–0.039] | 1.2 |
| C3 Dehu Road–Talegaon | 97 | 0.025 [0.023–0.028] | 0.8 |
| **Whole corridor** | 229 | **0.119 [0.115–0.124]** | **3.8** |
...
|---|---|---|---|---|---|---|---|
| Flux divergence (kg/s) | 0.068 | 0.204 | 0.342 | 0.469 | **0.571** | 0.644 | 0.700 |
...
|---|---|---|---|
| Main | 0.119 | 0.209 | 0.218 |
| Lifetime × 0.7 | 0.155 | 0.209 | 0.227 |
| Lifetime × 1.3 | 0.100 | 0.210 | 0.212 |
| Lifetime ÷ 0.84 (synthetic-bias corrected) | 0.106 | 0.210 | 0.214 |
| Background 5th percentile | 0.123 | 0.206 | 0.219 |
| Background 25th percentile | 0.113 | 0.216 | 0.217 |
| Wind at 100 m | 0.119 | 0.216 | 0.231 |

**The absolute corridor total ranges −16% to +30%; the corridor share varies by only ±2.5%.** This is the basis for D10: the **city total comes from EMG**, and the **split between zones from flux-divergence shares**.
...
| | NOx (kt/yr) |
|---|---|
| Satellite (EMG, midday rate) | **16.5** [95% CI 15.5–17.6] |
...
|---|---|
| **Satellite (TROPOMI NO₂ × EDGAR ratio), midday rate** | **2.84 ± 32% (1σ) → 1.95–3.74** |
...
| C2 PCMC | 6.4% | 0.18 |
| C3 Dehu Road–Talegaon | 4.4% | 0.13 |
| **Corridor** | **20.9%** | **0.60** |
...
| Wind regime (E-SE vs W-NW, half-difference) | 10.4% |
| NOx/NO₂ ratio (1.32 ± 0.1) | 7.6% |
| Wind level (850 hPa vs 100 m, half-difference) | 6.3% |
